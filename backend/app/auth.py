...
SECRET_KEY = os.getenv("SECRET_KEY", "supersecretkey_hrms_hackathon_2026_demo_key")
...
def get_current_user(
    ...
    try:
        ...
        if email is None:
            raise credentials_exception
        token_data = TokenData(email=email, role=UserRole(role_str) if role_str else None)
